<aside>
    ...
    <ul>
        <li class="<?php if ($page == "dashboard") {
            ...
            <a href="<?= $base_url ?>employer/dashboard.php">
        ...
        <li class="<?php if ($page == "profile-settings") {
            ...
            <a href="<?= $base_url ?>employer/profile-settings.php">
        ...
        <li class="<?php if ($page == "bookings") {
            ...
            <a href="<?= $base_url ?>employer/bookings.php">
        ...
        <li class="<?php if ($page == "transactions") {
            ...
            <a href="<?= $base_url ?>employer/transactions.php">
        ...
        <li class="<?php if ($page == "calendar") {
            ...
            <a href="<?= $base_url ?>employer/calendar.php">
        ...
        <li class="<?php if ($page == "payment-method") {
            ...
            <a href="<?= $base_url ?>employer/payment-method.php">
