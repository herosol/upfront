<?php echo getBredcrum(ADMIN, array('#' => 'Pet Sitter Signup Page')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Pet Sitter Signup Page</strong></h2>
    </div>
