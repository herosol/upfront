<?php if ($this->uri->segment(3) == 'detail'): ?>
    ...
    <div>
        ...
        <div class="row col-md-12">
            ...
            <h3>Selected Bank Detail</h3>
            <table class="table table-bordered">
                <tbody>
                    <tr>
                        <td><strong>Bank Title:</strong></td>
                        <td><?= $bank_row->acc_bank_name?></td>
                        <td><strong>Account Title:</strong></td>
                        <td><?= $bank_row->acc_title?></td>
                    </tr>
                    <tr>
                        <td><strong>Routing Number:</strong></td>
                        <td><?= $bank_row->acc_routing_number?></td>
                        <td><strong>Account Number:</strong></td>
                        <td><?= $bank_row->acc_number?></td>
                    </tr>
                    <tr>
                        <td><strong>City:</strong></td>
                        <td><?= $bank_row->acc_city?></td>
                        <td><strong>State:</strong></td>
                        <td><?= $bank_row->acc_state?></td>
                    </tr>
                    <tr>
                        <td><strong>Country:</strong></td>
                        <td><?= $bank_row->acc_country?></td>
                    </tr>
                </tbody>
            </table>
            <h3>Bookings</h3>
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php foreach ($with_trxs as $key => $trx): ?>
                        <tr>
                            <td><?= $key+1?></td>
                            <td><a href="<?= site_url(ADMIN.'/bookings/detail/'.$trx->booking_id)?>" target="__blank">Booking No. <?= $trx->booking_id?></a></td>
