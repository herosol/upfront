<?php if ($this->uri->segment(3) == 'manage'): ?>
    <?= showMsg(); ?>
    <?= getBredcrum(ADMIN, array('#' => 'Add/Update Buyer')); ?>
    <div class="row margin-bottom-10">
        <div class="col-md-6">
            <h2 class="no-margin"><i class="entypo-users"></i> Add/Update <strong>Buyer</strong></h2>
        </div>
        <div class="col-md-6 text-right">
            <a href="<?= site_url(ADMIN . '/buyers'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i> Cancel</a>
        </div>
    </div>
    <div>
        <hr>
        <div class="row col-md-12">
            <form action=""  role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <label class="control-label" for="mem_company"> Company (optional)</label>
                            <input type="text" name="mem_company" value="<?php if (isset($row->mem_company)) echo $row->mem_company; ?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
        ...
        <?php else: ?>
            <?= showMsg(); ?>
            <?= getBredcrum(ADMIN, array('#' => 'Manage Buyers')); ?>
            <div class="row margin-bottom-10">
                <div class="col-md-6">
                    <h2 class="no-margin"><i class="entypo-users"></i> Manage <strong>Buyers</strong></h2>
                </div>
                <div class="col-md-6 text-right">
                    <a href="<?= site_url(ADMIN . '/buyers/manage'); ?>" class="btn btn-lg btn-primary"><i class="fa fa-plus-circle"></i> Add New</a>
                </div>
            </div>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-primary" role="menu">
                                            <?php if ($row->mem_status == '0'): ?>
                                                <li><a href="<?= site_url(ADMIN); ?>/buyers/active/<?= $row->mem_id; ?>">Active</a></li>
                                                <?php else: ?>
                                                    <li><a href="<?= site_url(ADMIN); ?>/buyers/inactive/<?= $row->mem_id; ?>">Inactive</a></li>
                                                <?php endif; ?>

                                                <li><a href="<?= site_url(ADMIN); ?>/buyers/manage/<?= $row->mem_id; ?>">Edit</a></li>
                                                <?php if(access(10)):?>
                                                    <li><a href="<?= site_url(ADMIN); ?>/buyers/delete/<?= $row->mem_id; ?>" onclick="return confirm('Are you sure?');">Delete</a></li>
                                                <?php endif?>
                                        <li class="divider"></li>
                                        <!-- <li><a href="<?= site_url(ADMIN.'/buyers/comics/'.$row->mem_id); ?>" >Comics</a></li>
                                        <li><a href="<?= site_url(ADMIN.'/buyers/novels/'.$row->mem_id); ?>" >Novels</a></li>
                                        <li><a href="<?= site_url(ADMIN.'/buyers/transactions/'.$row->mem_id); ?>" >Transactions</a></li>
                                        <li><a href="<?= site_url(ADMIN.'/buyers/withdraws/'.$row->mem_id); ?>" >Withdraws</a></li> -->
                                        <li><a href="<?= site_url(ADMIN.'/buyers/payment-methods/'.$row->mem_id); ?>" >Payment Methods</a></li>
                                        <!-- <li><a href="<?= site_url(ADMIN.'/buyers/chats/'.$row->mem_id); ?>" >Chats</a></li> -->
                                    </ul>
                                </div>  
                            </td>
                        </tr>
