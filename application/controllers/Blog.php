...
class Blog extends MY_Controller
{
	...
	*/
	function index($cat_id = 0)
	{
		...
		$this->data['rows']         = $this->blog_model->get_rows($condition, '', 6, 'asc');
		$this->data['recent_blogs'] = $this->blog_model->get_rows(array(), '', 9, 'desc');
	...
	function detail($id)
	{
		...
		if($this->data['row'] = $this->blog_model->get_row($id)) 
		{
			...
			$this->data['recent_blogs'] = $this->blog_model->get_rows(array(), '', 6, 'desc');
